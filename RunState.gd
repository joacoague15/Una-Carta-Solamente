...
const LEVELS := {
	1: {
		...
		"enemies": [
			{"name":"goblin1","pos": Vector2i(2, 0)},
			{"name":"goblin2","pos": Vector2i(3, 2)},
		],
	},
	2: {
	...
	5: {
		...
		"enemy_base": {"hp": 2, "mv": 5, "atk": 4, "def": 4, "rng": 3},
		"enemies": [
			{"name":"spider1","pos": Vector2i(0, 1)},
			{"name":"spider2","pos": Vector2i(1, 4)},
			{"name":"spider3","pos": Vector2i(4, 4)},
